            ...
            <div className='bg-base-300 text-white mx-auto py-16 px-5 rounded-full'>
              ...
              <div className='pt-4 lg:w-1/2 w-3/4 mx-auto'>
                ...
                <p className='w-50 mx-auto py-3'>
                  ...
                  happend that the payment will be due. I am happy to be a part
                  of business chain of grage bikey moto.
                </p>
              </div>
            ...
            <div className='bg-base-300 text-white mx-auto py-16 px-5 rounded-full'>
              ...
              <div className='pt-4 lg:w-1/2 w-3/4 mx-auto'>
                ...
                <p className='w-50 mx-auto py-3'>
                  ...
                  this ware house and getting any product from this is going to
                  be the total fresh and new.
                </p>
              </div>
              <div className='absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2'>
                <a href='#slide2' className='btn btn-circle'>
